...
namespace vnotex
{
    ...
    {
    public:
        typedef std::function<QString(const Task *, const QString &)> Func;

        TaskVariable(const QString &p_name, const Func &p_func);

        QString evaluate(const Task *p_task, const QString &p_value) const;
    ...
    public:
        ...
        QString evaluate(const Task *p_task, const QString &p_text) const;

        QStringList evaluate(const Task *p_task, const QStringList &p_texts) const;
